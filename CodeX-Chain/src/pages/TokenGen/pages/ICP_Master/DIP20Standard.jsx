...
export default function DIP20Standard() {
  ...
  const handleCreateID = async () => {
    try {
      const response = await fetch('https://codexdev.tech:5005/api/identity', {
        method: 'POST',
        headers: {
...
/*
    ...
    try{
      const response = await fetch('https://codexdev.tech:5005/api/DIP20', {
        method: 'POST',
        headers: {  
          'Content-Type': 'application/json',
        },
...
/*  try{
    const response = await fetch('https://codexdev.tech:5005/api/checkcanister', {
      method: 'POST',
      headers: {  
        'Content-Type': 'application/json',
      },
...
try{
  ...
  axios.post('https://codexdev.tech:5005/api/saveDeployedTokens', { deployedTokens: [newToken] })
  .then(response => {
  ...
  axios.get(`https://codexdev.tech:5005/api/getDeployedTokens?category=${category}&walletAddress=${walletAddress}`)
    .then(response => {
  ...
  useEffect(() => {
    const fetchTotalCounts = async () => {
      try {
        ...
        const apiUrl = 'https://codexdev.tech:5005/api/getDeployedTokensCount';
