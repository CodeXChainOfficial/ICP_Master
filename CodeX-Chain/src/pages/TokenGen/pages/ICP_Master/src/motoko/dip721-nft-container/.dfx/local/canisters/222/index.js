...
import { idlFactory } from './222.did.js';
export { idlFactory } from './222.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.222_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./222.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the 222 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./222.did.js")._SERVICE>}
 */
export const 222 = createActor(canisterId);
