...
import { idlFactory } from './lokl.did.js';
export { idlFactory } from './lokl.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LOKL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lokl.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lokl canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lokl.did.js")._SERVICE>}
 */
export const lokl = createActor(canisterId);
