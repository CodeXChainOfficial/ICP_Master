...
import { idlFactory } from './MyCollection2.did.js';
export { idlFactory } from './MyCollection2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYCOLLECTION2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./MyCollection2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the MyCollection2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./MyCollection2.did.js")._SERVICE>}
 */
export const MyCollection2 = createActor(canisterId);
