...
import { idlFactory } from './gus.did.js';
export { idlFactory } from './gus.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GUS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gus.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gus canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gus.did.js")._SERVICE>}
 */
export const gus = createActor(canisterId);
