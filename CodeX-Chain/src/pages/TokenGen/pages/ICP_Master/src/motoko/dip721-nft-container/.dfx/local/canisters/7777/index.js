...
import { idlFactory } from './7777.did.js';
export { idlFactory } from './7777.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.7777_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./7777.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the 7777 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./7777.did.js")._SERVICE>}
 */
export const 7777 = createActor(canisterId);
