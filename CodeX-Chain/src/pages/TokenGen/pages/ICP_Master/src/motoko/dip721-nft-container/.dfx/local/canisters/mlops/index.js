...
import { idlFactory } from './mlops.did.js';
export { idlFactory } from './mlops.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MLOPS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mlops.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mlops canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mlops.did.js")._SERVICE>}
 */
export const mlops = createActor(canisterId);
