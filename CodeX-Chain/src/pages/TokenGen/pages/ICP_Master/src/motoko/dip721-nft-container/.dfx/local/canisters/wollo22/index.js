...
import { idlFactory } from './wollo22.did.js';
export { idlFactory } from './wollo22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WOLLO22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wollo22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wollo22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wollo22.did.js")._SERVICE>}
 */
export const wollo22 = createActor(canisterId);
