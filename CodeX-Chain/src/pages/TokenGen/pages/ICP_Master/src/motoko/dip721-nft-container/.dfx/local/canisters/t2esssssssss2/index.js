...
import { idlFactory } from './t2esssssssss2.did.js';
export { idlFactory } from './t2esssssssss2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.T2ESSSSSSSSS2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./t2esssssssss2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the t2esssssssss2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./t2esssssssss2.did.js")._SERVICE>}
 */
export const t2esssssssss2 = createActor(canisterId);
