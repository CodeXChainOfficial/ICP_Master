...
import { idlFactory } from './hhhhh.did.js';
export { idlFactory } from './hhhhh.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HHHHH_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhhhh.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhhhh canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhhhh.did.js")._SERVICE>}
 */
export const hhhhh = createActor(canisterId);
