...
import { idlFactory } from './collection_name_valuess1s.did.js';
export { idlFactory } from './collection_name_valuess1s.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.COLLECTION_NAME_VALUESS1S_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./collection_name_valuess1s.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the collection_name_valuess1s canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./collection_name_valuess1s.did.js")._SERVICE>}
 */
export const collection_name_valuess1s = createActor(canisterId);
