...
import { idlFactory } from './test22.did.js';
export { idlFactory } from './test22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test22.did.js")._SERVICE>}
 */
export const test22 = createActor(canisterId);
