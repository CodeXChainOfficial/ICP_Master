...
import { idlFactory } from './wolo.did.js';
export { idlFactory } from './wolo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WOLO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wolo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wolo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wolo.did.js")._SERVICE>}
 */
export const wolo = createActor(canisterId);
