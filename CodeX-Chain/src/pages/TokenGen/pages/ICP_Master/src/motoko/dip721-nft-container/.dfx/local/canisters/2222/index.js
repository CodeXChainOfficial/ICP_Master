...
import { idlFactory } from './2222.did.js';
export { idlFactory } from './2222.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.2222_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./2222.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the 2222 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./2222.did.js")._SERVICE>}
 */
export const 2222 = createActor(canisterId);
