...
import { idlFactory } from './luz.did.js';
export { idlFactory } from './luz.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LUZ_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./luz.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the luz canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./luz.did.js")._SERVICE>}
 */
export const luz = createActor(canisterId);
