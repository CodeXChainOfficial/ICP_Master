...
import { idlFactory } from './pippo21111.did.js';
export { idlFactory } from './pippo21111.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PIPPO21111_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pippo21111.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pippo21111 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pippo21111.did.js")._SERVICE>}
 */
export const pippo21111 = createActor(canisterId);
