...
import { idlFactory } from './MyCollection.did.js';
export { idlFactory } from './MyCollection.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYCOLLECTION_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./MyCollection.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the MyCollection canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./MyCollection.did.js")._SERVICE>}
 */
export const MyCollection = createActor(canisterId);
