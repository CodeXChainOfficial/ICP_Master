...
import { idlFactory } from './ssss.did.js';
export { idlFactory } from './ssss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SSSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ssss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ssss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ssss.did.js")._SERVICE>}
 */
export const ssss = createActor(canisterId);
