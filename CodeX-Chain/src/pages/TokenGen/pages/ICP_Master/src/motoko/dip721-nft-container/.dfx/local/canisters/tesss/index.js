...
import { idlFactory } from './tesss.did.js';
export { idlFactory } from './tesss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TESSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tesss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tesss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tesss.did.js")._SERVICE>}
 */
export const tesss = createActor(canisterId);
