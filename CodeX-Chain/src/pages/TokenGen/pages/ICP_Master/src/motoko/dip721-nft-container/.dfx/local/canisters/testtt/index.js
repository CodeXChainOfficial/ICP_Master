...
import { idlFactory } from './testtt.did.js';
export { idlFactory } from './testtt.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TESTTT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./testtt.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the testtt canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./testtt.did.js")._SERVICE>}
 */
export const testtt = createActor(canisterId);
