...
import { idlFactory } from './plo2.did.js';
export { idlFactory } from './plo2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PLO2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./plo2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the plo2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./plo2.did.js")._SERVICE>}
 */
export const plo2 = createActor(canisterId);
