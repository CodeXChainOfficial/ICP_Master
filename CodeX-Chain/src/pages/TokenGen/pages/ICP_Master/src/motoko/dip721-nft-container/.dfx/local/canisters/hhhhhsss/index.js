...
import { idlFactory } from './hhhhhsss.did.js';
export { idlFactory } from './hhhhhsss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HHHHHSSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hhhhhsss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hhhhhsss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hhhhhsss.did.js")._SERVICE>}
 */
export const hhhhhsss = createActor(canisterId);
