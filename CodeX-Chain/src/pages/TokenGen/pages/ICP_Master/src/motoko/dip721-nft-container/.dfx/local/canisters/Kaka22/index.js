...
import { idlFactory } from './Kaka22.did.js';
export { idlFactory } from './Kaka22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KAKA22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Kaka22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Kaka22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Kaka22.did.js")._SERVICE>}
 */
export const Kaka22 = createActor(canisterId);
