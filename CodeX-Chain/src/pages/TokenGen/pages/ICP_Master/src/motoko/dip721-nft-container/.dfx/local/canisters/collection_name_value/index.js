...
import { idlFactory } from './collection_name_value.did.js';
export { idlFactory } from './collection_name_value.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.COLLECTION_NAME_VALUE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./collection_name_value.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the collection_name_value canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./collection_name_value.did.js")._SERVICE>}
 */
export const collection_name_value = createActor(canisterId);
