...
import { idlFactory } from './gda.did.js';
export { idlFactory } from './gda.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GDA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gda.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gda canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gda.did.js")._SERVICE>}
 */
export const gda = createActor(canisterId);
