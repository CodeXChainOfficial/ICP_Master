...
import { idlFactory } from './kkkkk.did.js';
export { idlFactory } from './kkkkk.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KKKKK_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kkkkk.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kkkkk canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kkkkk.did.js")._SERVICE>}
 */
export const kkkkk = createActor(canisterId);
