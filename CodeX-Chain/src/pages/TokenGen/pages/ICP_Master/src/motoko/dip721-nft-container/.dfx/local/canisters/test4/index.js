...
import { idlFactory } from './test4.did.js';
export { idlFactory } from './test4.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST4_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test4.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test4 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test4.did.js")._SERVICE>}
 */
export const test4 = createActor(canisterId);
