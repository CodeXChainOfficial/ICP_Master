...
import { idlFactory } from './wollohs.did.js';
export { idlFactory } from './wollohs.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WOLLOHS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wollohs.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wollohs canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wollohs.did.js")._SERVICE>}
 */
export const wollohs = createActor(canisterId);
