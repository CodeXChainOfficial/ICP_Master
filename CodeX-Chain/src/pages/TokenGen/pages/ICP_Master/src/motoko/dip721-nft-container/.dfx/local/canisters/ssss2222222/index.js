...
import { idlFactory } from './ssss2222222.did.js';
export { idlFactory } from './ssss2222222.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SSSS2222222_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ssss2222222.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ssss2222222 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ssss2222222.did.js")._SERVICE>}
 */
export const ssss2222222 = createActor(canisterId);
