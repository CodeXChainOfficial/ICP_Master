...
export const canisterId = process.env.TEST2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test2.did.js")._SERVICE>}
 */
export const test2 = createActor(canisterId);
