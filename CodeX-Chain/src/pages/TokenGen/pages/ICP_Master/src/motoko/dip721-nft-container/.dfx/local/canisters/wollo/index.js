...
import { idlFactory } from './wollo.did.js';
export { idlFactory } from './wollo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WOLLO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wollo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wollo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wollo.did.js")._SERVICE>}
 */
export const wollo = createActor(canisterId);
