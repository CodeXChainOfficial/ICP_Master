...
import { idlFactory } from './truck.did.js';
export { idlFactory } from './truck.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TRUCK_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./truck.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the truck canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./truck.did.js")._SERVICE>}
 */
export const truck = createActor(canisterId);
