...
import { idlFactory } from './t2esssssss2.did.js';
export { idlFactory } from './t2esssssss2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.T2ESSSSSSS2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./t2esssssss2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the t2esssssss2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./t2esssssss2.did.js")._SERVICE>}
 */
export const t2esssssss2 = createActor(canisterId);
