...
import { idlFactory } from './test2w.did.js';
export { idlFactory } from './test2w.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST2W_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test2w.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test2w canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test2w.did.js")._SERVICE>}
 */
export const test2w = createActor(canisterId);
