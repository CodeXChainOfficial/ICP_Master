...
import { idlFactory } from './mlop.did.js';
export { idlFactory } from './mlop.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MLOP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./mlop.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the mlop canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./mlop.did.js")._SERVICE>}
 */
export const mlop = createActor(canisterId);
