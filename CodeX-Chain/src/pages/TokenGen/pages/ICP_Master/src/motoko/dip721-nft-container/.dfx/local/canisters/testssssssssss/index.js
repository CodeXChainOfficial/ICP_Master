...
import { idlFactory } from './testssssssssss.did.js';
export { idlFactory } from './testssssssssss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TESTSSSSSSSSSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./testssssssssss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the testssssssssss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./testssssssssss.did.js")._SERVICE>}
 */
export const testssssssssss = createActor(canisterId);
