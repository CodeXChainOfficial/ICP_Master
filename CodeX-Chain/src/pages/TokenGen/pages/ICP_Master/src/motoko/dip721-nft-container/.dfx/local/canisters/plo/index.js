...
import { idlFactory } from './plo.did.js';
export { idlFactory } from './plo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PLO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./plo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the plo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./plo.did.js")._SERVICE>}
 */
export const plo = createActor(canisterId);
