...
import { idlFactory } from './wolloh.did.js';
export { idlFactory } from './wolloh.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WOLLOH_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wolloh.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wolloh canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wolloh.did.js")._SERVICE>}
 */
export const wolloh = createActor(canisterId);
