...
import { idlFactory } from './test3.did.js';
export { idlFactory } from './test3.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST3_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test3.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test3 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test3.did.js")._SERVICE>}
 */
export const test3 = createActor(canisterId);
