...
import { idlFactory } from './wollog.did.js';
export { idlFactory } from './wollog.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WOLLOG_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wollog.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wollog canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wollog.did.js")._SERVICE>}
 */
export const wollog = createActor(canisterId);
