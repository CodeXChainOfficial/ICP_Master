...
import { idlFactory } from './lokls.did.js';
export { idlFactory } from './lokls.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LOKLS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lokls.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lokls canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lokls.did.js")._SERVICE>}
 */
export const lokls = createActor(canisterId);
