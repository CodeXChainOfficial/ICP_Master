...
import { idlFactory } from './test222.did.js';
export { idlFactory } from './test222.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST222_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test222.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test222 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test222.did.js")._SERVICE>}
 */
export const test222 = createActor(canisterId);
