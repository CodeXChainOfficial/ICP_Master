...
import { idlFactory } from './Kaka2.did.js';
export { idlFactory } from './Kaka2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KAKA2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Kaka2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Kaka2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Kaka2.did.js")._SERVICE>}
 */
export const Kaka2 = createActor(canisterId);
