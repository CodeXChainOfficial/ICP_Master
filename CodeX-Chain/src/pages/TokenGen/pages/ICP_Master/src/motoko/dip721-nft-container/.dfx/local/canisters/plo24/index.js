...
import { idlFactory } from './plo24.did.js';
export { idlFactory } from './plo24.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PLO24_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./plo24.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the plo24 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./plo24.did.js")._SERVICE>}
 */
export const plo24 = createActor(canisterId);
