...
import { idlFactory } from './tesssss2.did.js';
export { idlFactory } from './tesssss2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TESSSSS2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tesssss2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tesssss2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tesssss2.did.js")._SERVICE>}
 */
export const tesssss2 = createActor(canisterId);
