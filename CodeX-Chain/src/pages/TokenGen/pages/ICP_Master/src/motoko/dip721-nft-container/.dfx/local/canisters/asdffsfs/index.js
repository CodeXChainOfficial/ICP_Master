...
import { idlFactory } from './asdffsfs.did.js';
export { idlFactory } from './asdffsfs.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ASDFFSFS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./asdffsfs.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the asdffsfs canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./asdffsfs.did.js")._SERVICE>}
 */
export const asdffsfs = createActor(canisterId);
