...
import { idlFactory } from './ssss22222s22.did.js';
export { idlFactory } from './ssss22222s22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SSSS22222S22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ssss22222s22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ssss22222s22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ssss22222s22.did.js")._SERVICE>}
 */
export const ssss22222s22 = createActor(canisterId);
