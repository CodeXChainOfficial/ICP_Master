...
import { idlFactory } from './tesss2.did.js';
export { idlFactory } from './tesss2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TESSS2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tesss2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tesss2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tesss2.did.js")._SERVICE>}
 */
export const tesss2 = createActor(canisterId);
