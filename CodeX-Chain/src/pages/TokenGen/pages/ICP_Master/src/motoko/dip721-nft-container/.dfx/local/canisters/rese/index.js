...
import { idlFactory } from './rese.did.js';
export { idlFactory } from './rese.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.RESE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./rese.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the rese canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rese.did.js")._SERVICE>}
 */
export const rese = createActor(canisterId);
