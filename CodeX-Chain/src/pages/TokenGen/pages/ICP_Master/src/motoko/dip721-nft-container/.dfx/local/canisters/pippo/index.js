...
import { idlFactory } from './pippo.did.js';
export { idlFactory } from './pippo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PIPPO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pippo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pippo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pippo.did.js")._SERVICE>}
 */
export const pippo = createActor(canisterId);
