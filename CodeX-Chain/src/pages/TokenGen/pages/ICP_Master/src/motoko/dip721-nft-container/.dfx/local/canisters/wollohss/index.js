...
import { idlFactory } from './wollohss.did.js';
export { idlFactory } from './wollohss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WOLLOHSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wollohss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wollohss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wollohss.did.js")._SERVICE>}
 */
export const wollohss = createActor(canisterId);
