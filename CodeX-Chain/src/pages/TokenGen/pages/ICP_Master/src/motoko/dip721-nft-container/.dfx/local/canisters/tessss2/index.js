...
import { idlFactory } from './tessss2.did.js';
export { idlFactory } from './tessss2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TESSSS2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tessss2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tessss2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tessss2.did.js")._SERVICE>}
 */
export const tessss2 = createActor(canisterId);
