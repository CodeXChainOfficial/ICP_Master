...
import { idlFactory } from './tes1.did.js';
export { idlFactory } from './tes1.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TES1_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tes1.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tes1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tes1.did.js")._SERVICE>}
 */
export const tes1 = createActor(canisterId);
