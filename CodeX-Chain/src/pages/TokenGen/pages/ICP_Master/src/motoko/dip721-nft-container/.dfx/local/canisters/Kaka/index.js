...
import { idlFactory } from './Kaka.did.js';
export { idlFactory } from './Kaka.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.KAKA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Kaka.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Kaka canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Kaka.did.js")._SERVICE>}
 */
export const Kaka = createActor(canisterId);
