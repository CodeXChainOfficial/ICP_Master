...
import { idlFactory } from './res.did.js';
export { idlFactory } from './res.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.RES_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./res.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the res canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./res.did.js")._SERVICE>}
 */
export const res = createActor(canisterId);
