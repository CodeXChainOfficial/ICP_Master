...
import { idlFactory } from './MyCollection22.did.js';
export { idlFactory } from './MyCollection22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MYCOLLECTION22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./MyCollection22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the MyCollection22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./MyCollection22.did.js")._SERVICE>}
 */
export const MyCollection22 = createActor(canisterId);
