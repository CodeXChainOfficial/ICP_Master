...
import { idlFactory } from './test2w22.did.js';
export { idlFactory } from './test2w22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST2W22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test2w22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test2w22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test2w22.did.js")._SERVICE>}
 */
export const test2w22 = createActor(canisterId);
