...
import { idlFactory } from './loklssssssss.did.js';
export { idlFactory } from './loklssssssss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LOKLSSSSSSSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./loklssssssss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the loklssssssss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./loklssssssss.did.js")._SERVICE>}
 */
export const loklssssssss = createActor(canisterId);
