...
import { idlFactory } from './tst.did.js';
export { idlFactory } from './tst.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TST_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tst.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tst canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tst.did.js")._SERVICE>}
 */
export const tst = createActor(canisterId);
