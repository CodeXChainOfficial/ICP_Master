...
import { idlFactory } from './sss.did.js';
export { idlFactory } from './sss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sss.did.js")._SERVICE>}
 */
export const sss = createActor(canisterId);
