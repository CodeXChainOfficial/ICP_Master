...
export const canisterId = process.env.NAME_CANISTER_ID;
...
/**
 * A ready-to-use agent for the name canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./name.did.js")._SERVICE>}
 */
export const name = createActor(canisterId);
