...
import { idlFactory } from './tst22.did.js';
export { idlFactory } from './tst22.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TST22_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tst22.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tst22 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tst22.did.js")._SERVICE>}
 */
export const tst22 = createActor(canisterId);
