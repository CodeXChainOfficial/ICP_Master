...
import { idlFactory } from './namess.did.js';
export { idlFactory } from './namess.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NAMESS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./namess.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the namess canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./namess.did.js")._SERVICE>}
 */
export const namess = createActor(canisterId);
