...
import { idlFactory } from './sssssss.did.js';
export { idlFactory } from './sssssss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SSSSSSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sssssss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sssssss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sssssss.did.js")._SERVICE>}
 */
export const sssssss = createActor(canisterId);
