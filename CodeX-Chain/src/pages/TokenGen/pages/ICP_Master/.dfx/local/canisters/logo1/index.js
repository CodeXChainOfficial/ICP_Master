...
import { idlFactory } from './logo1.did.js';
export { idlFactory } from './logo1.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LOGO1_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./logo1.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the logo1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./logo1.did.js")._SERVICE>}
 */
export const logo1 = createActor(canisterId);
