...
import { idlFactory } from './namee.did.js';
export { idlFactory } from './namee.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NAMEE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./namee.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the namee canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./namee.did.js")._SERVICE>}
 */
export const namee = createActor(canisterId);
