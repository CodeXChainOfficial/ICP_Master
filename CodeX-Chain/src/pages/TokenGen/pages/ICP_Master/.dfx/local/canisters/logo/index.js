...
import { idlFactory } from './logo.did.js';
export { idlFactory } from './logo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LOGO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./logo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the logo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./logo.did.js")._SERVICE>}
 */
export const logo = createActor(canisterId);
