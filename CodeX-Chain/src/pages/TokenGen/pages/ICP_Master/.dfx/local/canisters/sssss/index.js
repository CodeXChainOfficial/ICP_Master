...
import { idlFactory } from './sssss.did.js';
export { idlFactory } from './sssss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SSSSS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sssss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sssss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sssss.did.js")._SERVICE>}
 */
export const sssss = createActor(canisterId);
