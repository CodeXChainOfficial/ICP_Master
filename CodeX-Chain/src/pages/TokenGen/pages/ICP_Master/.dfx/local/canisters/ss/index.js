...
import { idlFactory } from './ss.did.js';
export { idlFactory } from './ss.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ss.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ss canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ss.did.js")._SERVICE>}
 */
export const ss = createActor(canisterId);
