...
import { idlFactory } from './logo11.did.js';
export { idlFactory } from './logo11.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LOGO11_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./logo11.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the logo11 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./logo11.did.js")._SERVICE>}
 */
export const logo11 = createActor(canisterId);
