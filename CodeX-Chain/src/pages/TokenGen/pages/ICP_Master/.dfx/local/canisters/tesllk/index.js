...
import { idlFactory } from './tesllk.did.js';
export { idlFactory } from './tesllk.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TESLLK_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tesllk.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tesllk canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tesllk.did.js")._SERVICE>}
 */
export const tesllk = createActor(canisterId);
