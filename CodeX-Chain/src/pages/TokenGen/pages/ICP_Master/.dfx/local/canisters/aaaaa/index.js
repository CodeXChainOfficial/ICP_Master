...
import { idlFactory } from './aaaaa.did.js';
export { idlFactory } from './aaaaa.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.AAAAA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./aaaaa.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aaaaa canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./aaaaa.did.js")._SERVICE>}
 */
export const aaaaa = createActor(canisterId);
