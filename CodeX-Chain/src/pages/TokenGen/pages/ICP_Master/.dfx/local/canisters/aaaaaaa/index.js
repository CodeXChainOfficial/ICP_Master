...
import { idlFactory } from './aaaaaaa.did.js';
export { idlFactory } from './aaaaaaa.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.AAAAAAA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./aaaaaaa.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the aaaaaaa canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./aaaaaaa.did.js")._SERVICE>}
 */
export const aaaaaaa = createActor(canisterId);
