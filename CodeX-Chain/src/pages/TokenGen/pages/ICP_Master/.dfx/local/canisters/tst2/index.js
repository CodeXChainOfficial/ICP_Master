...
import { idlFactory } from './tst2.did.js';
export { idlFactory } from './tst2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TST2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tst2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tst2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tst2.did.js")._SERVICE>}
 */
export const tst2 = createActor(canisterId);
