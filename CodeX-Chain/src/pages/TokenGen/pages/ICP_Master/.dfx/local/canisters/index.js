...
export { idlFactory } from './.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env._CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the  canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./.did.js")._SERVICE>}
 */
